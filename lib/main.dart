...
void main() async {
  ...
  // Initialize global timer service
  await Get.putAsync(() => GlobalTimerService().init());
...
class _MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  void initState() {
    getCurrentAppTheme();
    // ✅ CRITICAL FIX: Don't create DashBoardController here!
    // It should only be created when DashBoardScreen is actually displayed
    // Get.put(DashBoardController()); // REMOVED
