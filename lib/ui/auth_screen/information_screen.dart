          ...
          body: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Image.asset("assets/images/info.jpeg",
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                            "Create your account to start using Wdni".tr,
                            style: GoogleFonts.poppins(
                        ...
                        onPress: () async {
                          if (controller
                            ...
                            if (controller
                              ...
                              FireStoreUtils.checkReferralCodeValidOrNot(
                                ...
                                if (value == true) {
                                  ...
                                  await FireStoreUtils.updateUser(userModel)
                                    ...
                                    print("------>$value");
                                    if (value == true) {
                                      // ✅ CRITICAL FIX: Set guest flag to false when completing user registration
                              ...
                              await FireStoreUtils.updateUser(userModel).then(
                                (value) {
                                  ShowToastDialog.closeLoader();
                                  print("------>$value");
                                  if (value == true) {
                                    // ✅ CRITICAL FIX: Set guest flag to false when completing user registration (no referral)
                                    Constant.isGuestUser = false;
                                    Get.offAll(const DashBoardScreen());
                                  }
                                },
