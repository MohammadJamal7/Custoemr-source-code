...
class ReferralScreen extends StatelessWidget {
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  "${"Earn".tr} ${Constant.amountShow(amount: Constant.referralAmount.toString())}"
                                      .tr,
                                ...
                                child: SingleChildScrollView(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "${"Invite WDNI to sign up using your link and you’ll get".tr} ${Constant.amountShow(amount: Constant.referralAmount.toString())} ${"addReferralTitle".tr}"
                                            .tr,
                                        style: GoogleFonts.poppins(
  ...
  Future<void> share(ReferralController controller) async {
    ...
    String message =
        "${"whatsappMessage".tr} ${controller.referralModel.value.referralCode.toString()} ${"Earn".tr} ${Constant.amountShow(amount: Constant.referralAmount)}";
    await Share.share(subject: 'WDNI'.tr, message);
  }
}
