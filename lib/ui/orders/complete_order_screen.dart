                                    ...
                                    child: SingleChildScrollView(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          DriverView(
                                            driverId: controller.orderModel.value.driverId.toString(),
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              ...
                                                              SizedBox(
                                                                height: controller.driverModel.value.vehicleInformation!.is_AC == false ? 0 : 10,
                                                              ),
                                                              controller.driverModel.value.vehicleInformation!.is_AC == false
                                                                  ? SizedBox()
                                                                  : Row(
                                                                      children: [
                                                                        const Icon(
                                                                        ...
                                                                        Text(controller.driverModel.value.vehicleInformation!.is_AC == true ? "AC".tr : "Non AC".tr,
                                                      ...
                                                      Expanded(
                                                        child: Row(
                                                          children: [
                                                            ...
                                                            Text(controller.orderModel.value.duration ?? "", style: GoogleFonts.poppins(fontWeight: FontWeight.w500)),
                                                          ],
                                                        ),
                                                      ),
                                                    ],
                                              ...
                                              child: Padding(
                                                  ...
                                                  child: Center(
                                                    child: Row(
                                                      children: [
                                                        Expanded(
                                                            child: Text(controller.orderModel.value.status.toString().tr, style: GoogleFonts.poppins(fontWeight: FontWeight.w500))),
                                                    ...
                                                    children: [
                                                      ...
                                                      Container(
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Text(
                                                            controller.orderModel.value.paymentType.toString().tr,
                                                            style: GoogleFonts.poppins(fontWeight: FontWeight.w600),
                                                          ),
                                                        ),
                                                      ),
