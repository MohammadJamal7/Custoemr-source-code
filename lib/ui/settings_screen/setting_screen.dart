                                    ...
                                    children: [
                                            ...
                                            SizedBox(
                                              ...
                                              child: DropdownButtonFormField(
                                                  ...
                                                  items: controller.languageList.map((item) {
                                                    String currentAppLang = Get.locale?.languageCode ?? 'en';
                                                    String displayName = item.name.toString();

                                                    if (currentAppLang == 'ar') {
                                                      if (displayName.toLowerCase() == 'arabic') {
                                                        displayName = 'العربية';
                                                      } else if (displayName.toLowerCase() == 'english') {
                                                        displayName = 'الإنجليزية';
                                                      }
                                                    }
                                            ...
                                            SizedBox(
                                              ...
                                              child: DropdownButtonFormField<String>(
                                                ...
                                                onChanged: (value) {
                                                  ...
                                                  log(value);
                                                  Preferences.setString(Preferences.themKey, value);
                                                  ...
                                                  controller.update(); // تحدث الـ dropdown
                                                },
                                                hint: Text("select".tr),
                                                items: controller.modeList.map((item) {
                                                  return DropdownMenuItem(
                                                    value: item,
                                                    child: Text(item.tr, style: GoogleFonts.poppins(fontWeight: FontWeight.w500)),
                                                  );
                                                }).toList(),
                                              ),
                                            ),
                                      ...
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          child: Row(
                                            children: [
                                              SvgPicture.asset('assets/icons/site.svg', width: 24),
                                              const SizedBox(
                                                width: 20,
                                              ),
                                              Text("webSite".tr, style: GoogleFonts.poppins(fontWeight: FontWeight.w500)),
                                            ],
                                          ),
                                        ),
                                      ),
                                      ...
                                      Padding(
                                        ...
                                        child: InkWell(
                                          onTap: () async {
                                            String message = "الشكاوي و المقترحات, كيف يمكنني مساعدتك ؟";
                                            final Uri url =
                                            Uri.parse("https://wa.me/${Constant.phone.toString()}?text=${Uri.encodeComponent(message)}");
                                            if (!await launchUrl(url)) {
                                              throw Exception(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text("contactUs".tr, style: GoogleFonts.poppins(fontWeight: FontWeight.w500))
                                            ],
                                          ),
                                        ),
                                      ),
                                      ...
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          child: Row(
                                            children: [
                                              SvgPicture.asset('assets/icons/ic_rate.svg', width: 24),
                                              const SizedBox(
                                                width: 20,
                                              ),
                                              Text("RateUs".tr, style: GoogleFonts.poppins(fontWeight: FontWeight.w500))
                                            ],
                                          ),
                                        ),
                                      ),
