                            ...
                            child: Padding(
                              ...
                              child: StreamBuilder(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    print(
                                        "🔄 INTERCITY STREAMBUILDER CALLED - ConnectionState: ${snapshot.connectionState}");
                                    print(
                                        "🔍 DEBUG INTERCITY: paymentStatus = ${orderModel.paymentStatus}");
                                    print(
                                        "🔍 DEBUG INTERCITY: status = ${orderModel.status}");
                                    print(
                                        "🔍 DEBUG INTERCITY: paymentType = ${orderModel.paymentType}");
                                    print(
                                        "🔍 DEBUG INTERCITY: rideComplete = ${Constant.rideComplete}");
                                    print(
                                        "🔍 DEBUG INTERCITY: orderId = ${orderModel.id}");
                                    ...
                                    if (orderModel.paymentStatus == true &&
                                      ...
                                      WidgetsBinding.instance
                                        ...
                                        print(
                                            "🚀 NAVIGATING TO INTERCITY COMPLETED RIDES TAB FROM PAYMENT SCREEN");
                                        Get.offAll(() =>
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                                    ...
                                                    Get.to(const CouponScreen())!
                                                      ...
                                                      if (value != null) {
                                                        controller
                                                            .selectedCouponModel
                                                            .value = value;
                                                        // Compute discount and clamp to base fare (finalRate)
                                                        ...
                                                        // Refresh UI to reflect new totals
                                                        controller.update();
                                                      }
                                                    });
                                                  },
                                            ...
                                            ButtonThem.buildButton(
                                              ...
                                              title: "Pay".tr,
                                              onPress: () {
                                                // Check if user is guest before showing payment dialog
                                                if (controller.userModel.value.fullName?.isEmpty == true || controller.userModel.value.fullName == null) {
                                                  showDialog(
                        ...
                        String wallet =
                            controller.paymentModel.value.wallet == null
                                ...
                                : controller.paymentModel.value.wallet!.name
                                    .toString();
                        log("wallet = $wallet");
                        log("Method = ${controller.selectedPaymentMethod.value}");
